...
//modify by FIT2CLOUD
if(p.tagName=="DIV" && $(p).attr('class') && $(p).attr('class').indexOf("easyui-window")>-1){
return {width:$(p).width(),height:$(p).height()};
}else{
return {width:$(p).width(),height:$(p).height() - 160};
}
};
})(jQuery);
(function($){
...
},beforePageText:"页数",afterPageText:"of {pages}",displayMsg:"共有{total}条记录; 当前显示: {from} - {to}",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"该项是必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入有效的email地址."},url:{validator:function(_3e9){
...
},message:"请输入有效的URL."},length:{validator:function(_3ea,_3eb){
var len=$.trim(_3ea).length;
return len>=_3eb[0]&&len<=_3eb[1];
},message:"数据长度应在 {0} 到 {1} 之间."},remote:{validator:function(_3ec,_3ed){
var data={};
data[_3ed[1]]=_3ec;
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"处理中，请稍后...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_666,_667){
...
//Modified by FIT2CLOUD
,dataFilter:function(data, type) {
        var prefixes = ['//', 'while(1);', 'for(;;);'],
            i,
            l,
            pos;
